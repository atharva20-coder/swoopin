...
import { ChevronRight, Instagram, Facebook, Twitter, Linkedin, Youtube, MessageCircle, Mail, LayoutGrid } from "lucide-react";
...
const PLATFORM_CONFIG: Record<Platform, { name: string; color: string; bgGradient: string; icon: React.ElementType }> = {
  all: { name: 'All', color: '#6366F1', bgGradient: 'from-indigo-500 to-purple-500', icon: LayoutGrid },
  instagram: { name: 'Instagram', color: '#E1306C', bgGradient: 'from-[#833AB4] via-[#E1306C] to-[#F77737]', icon: Instagram },
  facebook: { name: 'Facebook', color: '#1877F2', bgGradient: 'from-[#1877F2] to-[#4A90D9]', icon: Facebook },
  twitter: { name: 'Twitter', color: '#000000', bgGradient: 'from-gray-800 to-gray-900', icon: Twitter },
  linkedin: { name: 'LinkedIn', color: '#0A66C2', bgGradient: 'from-[#0A66C2] to-[#0077B5]', icon: Linkedin },
  youtube: { name: 'YouTube', color: '#FF0000', bgGradient: 'from-[#FF0000] to-[#CC0000]', icon: Youtube },
  whatsapp: { name: 'WhatsApp', color: '#25D366', bgGradient: 'from-[#25D366] to-[#128C7E]', icon: MessageCircle },

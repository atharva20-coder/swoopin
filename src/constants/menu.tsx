...
import { Users, BarChart3, Building2, CreditCard, MessageCircle, Calendar, CalendarCheck, ShoppingBag, Megaphone } from 'lucide-react'
...
export const SIDEBAR_MENU: SideBarProps[] = [
  ...
  },
  {
    id: uuid(),
    label: 'commerce',
    icon: <ShoppingBag className="w-5 h-5 text-[#9B9CA0]" />,
    name: 'Commerce',
  },
  {
    id: uuid(),
    label: 'ads',
    icon: <Megaphone className="w-5 h-5 text-[#9B9CA0]" />,
    name: 'Ads',
  },
  {
    id: uuid(),

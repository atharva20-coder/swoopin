...
const WorldMap = dynamic(() => import("@/components/landing/WorldMap"), {
  ...
  loading: () => (
    <div className="w-full h-full flex items-center justify-center bg-gray-100 dark:bg-neutral-900/50 rounded-xl">
      <div className="animate-pulse text-gray-500 dark:text-neutral-500">
        Loading map...
      </div>
    </div>
  ),
...
function FlipCounter({ value }: { value: number }) {
  ...
  return (
    <div
      className="flex items-center text-5xl sm:text-7xl md:text-9xl font-bold tracking-tighter tabular-nums text-white"
      style={{ perspective: "1000px" }}
    >
      {currentDigits.map((digit, i) =>
        digit === "," ? (
          <span key={`comma-${i}`} className="mx-0.5">
            ,
          </span>
        ) : (
...
function FlowBuilderAnimation({ isActive }: { isActive: boolean }) {
  ...
  useEffect(() => {
    ...
    const timeline = [
      // === Select Posts ===
      {
        delay: 500,
        action: () => {
          setCursorPos({ x: 90, y: 220 });
          setActiveItem("select-posts");
        },
      },
      {
        delay: 1500,
      ...
      // === New Comment ===
      {
        delay: 5000,
        action: () => {
          setCursorPos({ x: 90, y: 100 });
          setActiveItem("new-comment");
        },
      },
      {
        delay: 6000,
      ...
      // === Draw connector: Select Posts → New Comment ===
      {
        delay: 9000,
        action: () => {
          setCursorPos({ x: 280, y: 115 });
          setIsConnecting(true);
        },
      }, // From Select Posts handle
      {
        delay: 10500,
        action: () => {
          setCursorPos({ x: 280, y: 145 });
      ...
      // === Keyword Match ===
      {
        delay: 12000,
        action: () => {
          setCursorPos({ x: 90, y: 180 });
          setActiveItem("keyword-match");
        },
      },
      {
        delay: 13000,
      ...
      // === Reply Comment ===
      {
        delay: 19000,
        action: () => {
          setCursorPos({ x: 90, y: 360 });
          setActiveItem("reply-comment");
        },
      },
      {
        delay: 20000,
      ...
      // === Smart AI ===
      {
        delay: 26000,
        action: () => {
          setCursorPos({ x: 90, y: 520 });
          setActiveItem("smart-ai");
        },
      },
      {
        delay: 27000,
      ...
      // === Send DM ===
      {
        delay: 33000,
        action: () => {
          setCursorPos({ x: 90, y: 320 });
          setActiveItem("send-dm");
        },
      },
      {
        delay: 34000,
  ...
  const triggers = [
    {
      ...
      icon: MessageCircle,
      label: "New Comment",
      desc: "Trigger on new comment",
    },
    {
      id: "new-dm",
      icon: Mail,
      label: "New DM",
      desc: "Trigger on direct message",
    },
    {
      id: "keyword-match",
      icon: Reply,
      label: "Keyword Match",
      desc: "Trigger on specific keyword",
    },
    {
      id: "select-posts",
      icon: Calendar,
      label: "Select Posts",
      desc: "Attach specific Instagram posts",
    },
    {
      id: "story-reply",
      icon: MessageCircle,
      label: "Story Reply",
      desc: "Trigger when someone replies",
    },
    {
      id: "button-click",
      icon: MousePointerClick,
      label: "Button Click",
      desc: "Trigger when user clicks",
    },
  ];
  ...
  const actions = [
    ...
    },
    {
      ...
      desc: "Send buttons with actions",
      pro: true,
    },
    {
      id: "ice-breakers",
    ...
    },
    {
      ...
      label: "Log to Sheets",
      desc: "Save data to Google Sheets",
    },
  ];
  ...
  return (
    <div className="relative bg-gray-100 dark:bg-neutral-900 w-full h-[350px] sm:h-[450px] lg:h-[600px] flex overflow-hidden rounded-2xl border border-gray-200 dark:border-neutral-800">
      ...
      <div className="relative w-40 lg:w-52 bg-gray-50 dark:bg-[#111] border-r border-gray-200 dark:border-neutral-800 p-3 lg:p-4 flex-shrink-0 overflow-y-auto hidden md:block">
        ...
        <div className="text-gray-500 dark:text-neutral-500 text-xs mb-4">
            ...
            {triggers.map((item) => (
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-[10px] text-gray-500 dark:text-neutral-500 block">
                    {item.desc}
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-1">
                    ...
                    {item.pro && (
                      <span className="text-[8px] px-1.5 py-0.5 bg-purple-500 text-white rounded-sm">
                        PRO
                      </span>
                    )}
                  </div>
            ...
            <div className="bg-blue-500 rounded-lg shadow-lg shadow-blue-500/30 min-w-[140px]">
              ...
              <div className="bg-blue-600/50 px-3 py-1.5 rounded-b-lg">
                <p className="text-blue-100 text-[10px]">
                  Attach specific Instagram posts
                </p>
              </div>
            </div>
          ...
          >
            <div className="bg-blue-500/20 border-2 border-blue-500 rounded-lg min-w-[180px]">
              ...
              <div className="px-3 py-2">
                <p className="text-gray-600 dark:text-neutral-400 text-[10px] mb-2">
                  Trigger on specific keyword
                </p>
      ...
      <div className="relative w-40 lg:w-52 bg-gray-50 dark:bg-[#111] border-l border-gray-200 dark:border-neutral-800 p-3 lg:p-4 flex-shrink-0 hidden md:block">
        <div className="text-gray-900 dark:text-white text-sm font-semibold mb-4">
          Configuration
        </div>

        {/* Automation Name */}
        <div className="mb-5">
          <label className="text-gray-500 dark:text-neutral-500 text-xs block mb-2">
            Automation Name
          </label>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-gray-200 dark:bg-neutral-800 rounded-lg p-3 text-center">
              <p className="text-[10px] text-gray-500 dark:text-neutral-500 mb-1">
                DMs Sent
              </p>
              <p
                className={cn(
...
function IntegrationsAnimation({ isActive }: { isActive: boolean }) {
  ...
  useEffect(() => {
    ...
    const timeline = [
      { delay: 500, action: () => setPhase(1) }, // Show floating icons
      {
        ...
        action: () => {
          setPhase(2);
          setConnectedIntegrations(["google-sheets"]);
        },
      },
      {
        delay: 3500,
        action: () => setConnectedIntegrations(["google-sheets", "instagram"]),
      },
      {
        delay: 5000,
        action: () =>
          setConnectedIntegrations(["google-sheets", "instagram", "canva"]),
      },
  ...
  const floatingIcons = [
    ...
    { id: "facebook", icon: Facebook, color: "bg-blue-600", x: 150, y: 180 },
    {
      id: "twitter",
      icon: Twitter,
      color: "bg-gray-200 dark:bg-neutral-800",
      x: 30,
      y: 210,
    },
  ...
  const integrations = [
    {
      ...
      icon: FileSpreadsheet,
      label: "Google Sheets",
      desc: "atharvajoshi2520@gmail.com",
      color: "bg-green-500",
      connected: true,
    },
    {
      ...
      icon: Palette,
      label: "Canva",
      desc: "Connect to import designs",
    ...
    },
    {
      ...
      icon: Instagram,
      label: "Instagram",
      desc: "Integrate your Instagram account to reach your audience",
      color: "bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400",
      connected: true,
    },
    {
      ...
      icon: Facebook,
      label: "Facebook",
      desc: "Connect with Facebook to expand your reach",
      color: "bg-blue-600",
      isNew: true,
    },
    {
      ...
      icon: MessageCircle,
      label: "Messenger",
      desc: "Connect with Facebook Messenger to engage with customers",
      color: "bg-gradient-to-br from-blue-500 to-purple-500",
      isNew: true,
    },
    {
      ...
      icon: MessageCircle,
      label: "Threads",
      desc: "Expand your reach through Threads Integration",
    ...
    <div className="relative bg-gray-100 dark:bg-neutral-900 w-full h-[350px] sm:h-[450px] lg:h-[600px] flex overflow-hidden rounded-2xl border border-gray-200 dark:border-neutral-800">
        ...
        {floatingIcons.map((item, i) => (
          <div
            ...
            style={{
              ...
              animation:
                phase >= 1
                  ? `float-${i % 2 === 0 ? "slow" : "medium"} ${3 + i * 0.5}s ease-in-out infinite`
                  : "none",
            }}
          >
          ...
          <div className="flex gap-2">
            ...
            <button
              className={cn(
                ...
                phase >= 4
                  ? "ring-2 ring-blue-400 ring-offset-2 ring-offset-[#111]"
                  : "",
              )}
            >
              Continue →
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex items-center gap-1 mb-6">
          <button className="px-4 py-2 bg-gray-200 dark:bg-neutral-800 rounded-lg text-gray-900 dark:text-white text-xs font-medium">
            View all
          </button>
          <button className="px-4 py-2 text-gray-500 dark:text-neutral-500 text-xs hover:text-gray-900 dark:hover:text-gray-900 dark:hover:text-white transition-colors">
            Social Media
          </button>
          <button className="px-4 py-2 text-gray-500 dark:text-neutral-500 text-xs hover:text-gray-900 dark:hover:text-gray-900 dark:hover:text-white transition-colors">
            Messaging
          ...
          {integrations.map((item, i) => (
            <div
              ...
              className={cn(
                ...
                connectedIntegrations.includes(item.id)
...
function InboxAnimation({ isActive }: { isActive: boolean }) {
  ...
  const chats = [
    {
      name: "Sarah Johnson",
      msg: "Hey! Love your content 💕 Can I get the link?",
      time: "2m",
      avatar: "S",
      unread: true,
    },
    {
      name: "Mike Roberts",
      msg: "Just saw your story, amazing work!",
      time: "15m",
      avatar: "M",
      unread: true,
    },
    ...
    {
      name: "Alex Kim",
      msg: "Interested in the collab opportunity",
      time: "2h",
      avatar: "A",
      unread: false,
    },
        ...
        {chats.map((chat, i) => (
          <div
            ...
            className={cn(
              ...
              chat.unread
                ? "bg-gray-200 dark:bg-neutral-800/80"
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                ...
                <p className="text-gray-500 dark:text-neutral-600 text-xs">
                  {chat.time}
                </p>
              </div>
    ...
    <div className="relative w-full h-full min-h-[400px] bg-neutral-950 rounded-xl overflow-hidden p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div
            key={i}
            className="bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 text-center"
          >
            <p className="text-gray-500 dark:text-neutral-500 text-xs mb-1">
              {stat.label}
            </p>
      ...
      <div className="bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <span className="px-2 py-1 bg-gray-200 dark:bg-neutral-800 text-gray-600 dark:text-neutral-400 rounded text-xs">
              7 days
            </span>
  ...
  useEffect(() => {
    ...
    const timeline = [
      ...
      { delay: 6000, action: () => setPhase(3) }, // Click schedule
      {
        ...
        action: () => {
          setShowModal(false);
          setScheduledDays([16, 17]);
        },
      }, // Close modal, add new scheduled day
    ];
  ...
  return (
    <div className="relative bg-gray-100 dark:bg-neutral-900 w-full h-[350px] sm:h-[450px] lg:h-[600px] flex overflow-hidden rounded-2xl border border-gray-200 dark:border-neutral-800">
      ...
      <div className="w-44 lg:w-56 bg-gray-50 dark:bg-[#111] border-r border-gray-200 dark:border-neutral-800 p-3 lg:p-4 flex flex-col hidden md:flex">
        ...
        >
          <p className="text-gray-500 dark:text-neutral-500 text-xs mb-2">
            Design Tools
          </p>
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="ml-auto w-4 h-4 bg-blue-500 rounded-full text-[10px] text-white flex items-center justify-center">
              1
            </span>
          </div>
          <p className="text-gray-500 dark:text-neutral-500 text-[10px] mb-2">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-neutral-500 text-xs text-center py-4">
            No drafts yet
          </p>
        </div>
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <div className="flex bg-gray-200 dark:bg-neutral-800 rounded-lg overflow-hidden">
              <button className="px-3 py-1.5 bg-gray-300 dark:bg-neutral-700 text-gray-900 dark:text-white text-xs">
                Month
              </button>
              <button className="px-3 py-1.5 text-gray-500 dark:text-neutral-500 text-xs hover:text-gray-900 dark:hover:text-gray-900 dark:hover:text-white transition-colors">
                Week
              </button>
              <button className="px-3 py-1.5 text-gray-500 dark:text-neutral-500 text-xs hover:text-gray-900 dark:hover:text-gray-900 dark:hover:text-white transition-colors">
                Day
            ...
            <div className="flex items-center gap-1 ml-2">
              <button className="p-1.5 hover:bg-gray-200 dark:bg-neutral-800 rounded">
                <ChevronRight className="w-4 h-4 text-gray-500 dark:text-neutral-500 rotate-180" />
              </button>
              <button className="p-1.5 hover:bg-gray-200 dark:bg-neutral-800 rounded">
                <ChevronRight className="w-4 h-4 text-gray-500 dark:text-neutral-500" />
              </button>
            </div>
            <button className="px-3 py-1.5 bg-gray-200 dark:bg-neutral-800 hover:bg-gray-300 dark:hover:bg-neutral-700 rounded-lg text-gray-900 dark:text-white text-xs transition-colors">
              Today
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-7 gap-px bg-gray-200 dark:bg-neutral-800 rounded-xl overflow-hidden">
          ...
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((d) => (
            <div
              key={d}
              className="bg-gray-100 dark:bg-neutral-900 py-3 text-center text-gray-500 dark:text-neutral-500 text-xs font-medium"
            >
              {d}
            </div>
          ))}
            ...
            >
              <span
                className={cn(
                  "text-xs",
                  day.isToday
                    ? "w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white"
              ...
              {scheduledDays.includes(day.day) && !day.isOtherMonth && (
                <div className="absolute top-8 left-1 right-1 bg-blue-500/20 border border-blue-500/40 rounded-md p-1 transition-all duration-500">
                  <div className="flex items-center gap-1 mb-0.5">
                    <span className="px-1 py-0.5 bg-blue-500 rounded text-[8px] text-white">
                      Post
                    </span>
                  </div>
                  <p className="text-[9px] text-gray-600 dark:text-neutral-400">
                    Automation:
                  </p>
                  <p className="text-[9px] text-gray-900 dark:text-white">
                    Logical
                  </p>
                  <div className="flex items-center gap-1 mt-1">
                    <div className="w-2.5 h-2.5 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-full" />
                    <span className="text-[8px] text-gray-500 dark:text-neutral-500">
                      9:00 AM
                    </span>
                  </div>
                </div>
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-50">
          ...
          <div className="relative w-[280px] h-[520px] bg-[#1a1a1a] rounded-[40px] border-4 border-neutral-700 shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-neutral-500 text-[10px]">
                  Add location...
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-gray-500 dark:text-neutral-500 hover:text-gray-900 dark:hover:text-white">
                ×
              </button>
            </div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-neutral-800/50">
        {leads.map((lead, i) => (
          ...
          >
            ...
            <span className="text-gray-600 dark:text-neutral-400 text-base">
              {lead.handle}
            </span>
            <span className="text-gray-600 dark:text-neutral-400 text-base">
              {lead.email}
            ...
            <span className="text-gray-500 dark:text-neutral-500 text-base">
              {lead.date}
            </span>
          </div>
        ))}
      ...
      {syncing && (
        <div className="absolute inset-0 bg-white/80 dark:bg-neutral-950/80 flex items-center justify-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-gray-500 dark:text-neutral-500 text-sm">
              Exporting {rows.length} new leads
            </p>
          </div>
        </div>
      )}
...
export default function LandingPage() {
  ...
  useEffect(() => {
    const animatedElements = document.querySelectorAll(
      ".animate-on-scroll, .stagger-children, .fade-in-left, .fade-in-right, .scale-in",
    );
  ...
  const features = [
    {
      ...
      description:
        "Link your Instagram, Facebook, and other social accounts. Add Google Sheets, Canva, and more to supercharge your workflow.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Create powerful automation workflows with our drag-and-drop builder. Triggers, conditions, and actions—no code required.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Plan and schedule content with Canva integration and AI-generated captions.",
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "Export leads to Google Sheets, track conversations, and manage all your audience data in one place.",
      icon: Database,
  ...
  const capabilities = [
    {
      icon: Bot,
      title: "AI Responses",
      description: "Smart replies that match your voice",
    },
    ...
    },
    {
      icon: Calendar,
      title: "Scheduler",
      description: "Canva integration built-in",
    },
    {
      icon: Sparkles,
      title: "AI Captions",
      description: "Generate converting copy",
    },
    {
      icon: Database,
      title: "Data Hub",
      description: "Export leads to Sheets",
    },
    {
      icon: MessageCircle,
      title: "Unified Inbox",
      description: "All messages, one place",
    },
    {
      icon: Users,
      title: "Collabs",
        ...
        const scrollProgress = Math.max(
          ...
          Math.min(
            ...
            (viewportHeight * 0.5 - rect.top) /
              (containerHeight - viewportHeight * 0.5),
          ),
        );
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300">
              ...
              <div className="w-full">
                ...
                >
                  <motion.span
                    ...
                    style={{
                      backgroundImage:
                        "linear-gradient(to right, #60A5FA, #22D3EE, #60A5FA, #EB491C, #60A5FA, #22D3EE)",
                  ...
                  <motion.span
                    ...
                    style={{
                      backgroundImage:
                        "linear-gradient(to right, #22D3EE, #60A5FA, #22D3EE, #EB491C, #22D3EE, #60A5FA)",
                      backgroundSize: "200% auto",
                    }}
                    className="text-transparent bg-clip-text"
                  >
                ...
                >
                  Connect Instagram, CRMs, Canva, Google Sheets and more.
                  Automate DMs, schedule posts, and capture leads — all in one
                  place.
                </motion.p>
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 dark:text-neutral-500 font-medium">
          ...
          <div className="relative w-full max-w-7xl mx-auto">
            ...
            <div className="text-center mb-10 sm:mb-16 animate-on-scroll pt-8">
              ...
              <p className="text-gray-500 dark:text-neutral-500 text-base sm:text-lg max-w-2xl mx-auto">
                Everything you need to manage and grow your social presence in
              ...
              <div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-neutral-800">
                ...
                <div className="hidden sm:flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-blue-500 rounded-full text-[8px] text-white flex items-center justify-center">
                      10
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 p-3 sm:p-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 mb-4 sm:mb-6">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl p-2 sm:p-4"
                      >
                        <div
                          className={cn(
                        ...
                        <p className="text-gray-500 dark:text-neutral-500 text-[10px] sm:text-xs hidden sm:block">
                          {stat.sub}
                        </p>
                      </div>
                    ))}
                    ...
                    <div className="bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 flex flex-col">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <span className="flex items-center gap-1 text-xs text-gray-700 dark:text-white">
                          <div className="w-2 h-2 bg-blue-500 rounded-full" />{" "}
                          Messages (
                          <CountingNumber value={845} duration={1.5} />)
                        </span>
                        <span className="flex items-center gap-1 text-xs text-gray-700 dark:text-white">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full" />{" "}
                          Responses (
                          <CountingNumber value={2450} duration={1.5} />)
                        </span>
                      </div>
                      {/* Area Chart */}
                      <div className="flex-1 min-h-[160px] bg-gray-200 dark:bg-neutral-900 rounded-lg relative overflow-hidden">
                        ...
                        <div className="absolute left-4 bottom-4 text-[10px] text-gray-500 dark:text-neutral-600">
                          22 Dec
                        </div>
                        <div className="absolute right-4 bottom-4 text-[10px] text-gray-500 dark:text-neutral-600">
                          26 Dec
                        </div>
                        <svg
                        ...
                        >
                          ...
                          <motion.path
                            initial={{
                              d: "M0 128 L60 128 L120 128 L180 128 L240 128 L300 128 L360 128 L400 128 L400 128 L0 128 Z",
                            }}
                            whileInView={{
                              d: "M0 110 L60 90 L120 95 L180 75 L240 85 L300 65 L360 80 L400 70 L400 128 L0 128 Z",
                            }}
                            viewport={{ once: true }}
                          ...
                          <motion.path
                            ...
                            whileInView={{
                              d: "M0 100 L60 105 L120 98 L180 102 L240 95 L300 100 L360 92 L400 98 L400 128 L0 128 Z",
                            }}
                            viewport={{ once: true }}
                            transition={{
                              duration: 2,
                    ...
                    <div className="bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl p-4 flex flex-col">
                      ...
                      <div className="grid grid-cols-4 gap-2 mb-4">
                        {[
                          ...
                          <div
                            key={i}
                            className="bg-gray-200 dark:bg-neutral-800/50 rounded-lg p-3"
                          >
                      ...
                      {/* Top Performers */}
                      <div className="mt-4">
                        <p className="text-gray-600 dark:text-neutral-400 text-xs mb-2">
                        ...
                        <div className="flex items-center justify-between bg-gray-200 dark:bg-neutral-800/30 rounded-lg p-2">
                          <div className="flex items-center gap-2">
                            <span className="w-5 h-5 bg-blue-500 rounded text-white text-[10px] flex items-center justify-center">
                              1
                            </span>
                            <div>
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <div className="relative overflow-hidden w-full max-w-[100vw] sm:max-w-7xl mx-auto mask-linear-fade">
              ...
              <div className="flex gap-4 sm:gap-8 mb-4 sm:mb-6 w-max animate-scroll-left">
                {[...platforms, ...platforms, ...platforms, ...platforms].map(
                  (platform, i) => (
                    <div
                      key={`${platform.name}-${i}`}
                      className={cn(
                    ...
                    >
                      ...
                      {platform.coming && (
                        <span className="text-[10px] uppercase tracking-wider font-bold px-1.5 py-0.5 bg-gray-100 dark:bg-neutral-800 rounded text-gray-400 dark:text-neutral-500">
                          Soon
                        </span>
                      )}
                    </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-gray-500 dark:text-neutral-500 text-lg max-w-2xl mx-auto">
                Stop struggling with clunky tools. Start building with a
              ...
              <div className="relative p-8 rounded-3xl border border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/30 opacity-70 scale-95 grayscale transition-all duration-500 hover:grayscale-0 hover:scale-100 hover:opacity-100">
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-4 text-gray-400 dark:text-neutral-500">
                    ...
                    <div>
                      <strong className="block text-gray-600 dark:text-neutral-400 font-semibold">
                        Cluttered Interfaces
                      </strong>
                      <span className="text-sm">
                        Confusing dashboards that take weeks to learn
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 text-gray-400 dark:text-neutral-500">
                    ...
                    <div>
                      <strong className="block text-gray-600 dark:text-neutral-400 font-semibold">
                        Expensive Global Pricing
                      </strong>
                      <span className="text-sm">
                        High monthly fees in $$ that hurt your wallet
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 text-gray-400 dark:text-neutral-500">
                    ...
                    <div>
                      ...
                      <span className="text-sm">
                        Barriers to entry before you even start
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 text-gray-400 dark:text-neutral-500">
                    ...
                    <div>
                      ...
                      <span className="text-sm">
                        Dated designs that don&apos;t stand out
                      </span>
                    </div>
                  </li>
                </ul>
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-500 dark:text-neutral-400">
                        Zero bloat. Built for speed and ease of use.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <strong className="block text-gray-900 dark:text-white font-bold">
                        Localized Pricing & UPI
                      </strong>
                      <span className="text-sm text-gray-500 dark:text-neutral-400">
                        Affordable plans with seamless Indian payment support
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-500 dark:text-neutral-400">
                        Start building instantly, purely friction-free.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-500 dark:text-neutral-400">
                        Premium aesthetics that wow your audience.
                      </span>
                    </div>
                  </li>
                </ul>
        ...
        <section
          id="features"
          className="lg:hidden py-12 px-5 border-t border-gray-200 dark:border-neutral-800"
        >
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-neutral-800 divide-y divide-gray-200 dark:divide-neutral-800">
              {features.map((feature, i) => (
                ...
                >
                  <button
                    onClick={() =>
                      setActiveFeature(activeFeature === i ? -1 : i)
                    }
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 dark:text-gray-500 dark:text-neutral-500 text-xs">
                          {feature.label}
                        </p>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <div className="pl-8">
                            ...
                            <Link
                              href="/dashboard"
                              className="inline-flex items-center gap-1 text-sm text-white mt-2 hover:gap-2 transition-all"
                            >
                ...
                <div className="lg:col-span-9">
                  <div className="bg-gray-100 dark:bg-neutral-900/30 border border-gray-200 dark:border-neutral-800 rounded-2xl overflow-hidden min-h-[600px]">
                    {features.map((feature, i) => (
                      ...
                      >
                        <feature.component
                          isActive={activeFeature === i && isInView}
                        />
                      </div>
                    ))}
                  </div>
        ...
        <section
          id="solutions"
          className="min-h-[80vh] sm:min-h-screen flex flex-col justify-center py-16 sm:py-32 px-5 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-neutral-800"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 stagger-children">
              {capabilities.map((cap, i) => (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 dark:text-neutral-500 leading-relaxed">
                    {cap.description}
                  </p>
                </div>
              ))}
        ...
        <section
          id="pricing"
          className="min-h-[70vh] sm:min-h-screen flex flex-col justify-center py-16 sm:py-32 px-5 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-neutral-800"
        >
              ...
              {[
                {
                  ...
                  description:
                    "Link Instagram and other platforms with secure OAuth",
                },
                {
                  step: 2,
                  title: "Build your automations",
                  description:
                    "Use the visual flow builder to create workflows",
                },
                {
                  step: 3,
                  title: "Grow on autopilot",
                  description:
                    "Watch your engagement and leads increase automatically",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 sm:gap-6 py-6 sm:py-8 border-b border-gray-200 dark:border-neutral-800 last:border-0"
                >
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-gray-500 dark:text-neutral-500 text-base sm:text-lg max-w-2xl mx-auto px-2">
                Deep insights into who&apos;s engaging with your content across
                the globe
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-[#0f0f0f] rounded-xl sm:rounded-2xl border border-gray-200 dark:border-neutral-800 overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-3 sm:py-4 gap-2 sm:gap-0 border-b border-gray-200 dark:border-neutral-800">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <span className="px-2 sm:px-3 py-1 bg-purple-500/20 text-purple-400 text-[10px] sm:text-xs rounded-lg">
                    Sample Data
                  </span>
                  <div className="flex bg-gray-200 dark:bg-neutral-800 rounded-lg overflow-hidden text-[10px] sm:text-xs">
                    <button className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gray-300 dark:bg-neutral-700 text-white">
                      All
                    </button>
                    <button className="px-2 sm:px-3 py-1 sm:py-1.5 text-gray-500 dark:text-neutral-500">
                      Cities
                    </button>
                    <button className="px-2 sm:px-3 py-1 sm:py-1.5 text-gray-500 dark:text-neutral-500 hidden sm:block">
                      Countries
                    </button>
                  </div>
                </div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2">
                          <span className="text-gray-500 dark:text-neutral-500 text-xs w-10">
                            {item.age}
                          </span>
                  ...
                  <div className="bg-gray-100 dark:bg-neutral-900/50 rounded-xl p-4">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="w-5 h-5 bg-gray-200 dark:bg-neutral-800 rounded text-gray-600 dark:text-gray-500 dark:text-neutral-500 text-xs flex items-center justify-center">
                              {loc.rank}
                            </span>
        ...
        {/* Testimonials Section - Premium Card Carousel */}
        <section className="relative min-h-[80vh] sm:min-h-screen flex flex-col justify-center py-16 sm:py-32 px-5 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-neutral-800/50 overflow-hidden bg-black">
          <div className="relative max-w-7xl mx-auto w-full">
            <div className="text-center mb-10 sm:mb-16 animate-on-scroll">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-3 sm:mb-4 text-white">
                Loved by creators worldwide
              </h2>
              <p className="text-neutral-400 text-base sm:text-lg max-w-2xl mx-auto px-2">
                See what our users are saying about transforming their social
                media growth
              </p>
            </div>
            ...
            <div className="relative">
              {/* Navigation Arrows */}
              <button className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black/50 border border-white/20 flex items-center justify-center text-white hover:bg-black/70 transition-colors -translate-x-1/2 hidden lg:flex">
                <ChevronLeft className="w-5 h-5" />
              </button>
              <button className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black/50 border border-white/20 flex items-center justify-center text-white hover:bg-black/70 transition-colors translate-x-1/2 hidden lg:flex">
                <ChevronRight className="w-5 h-5" />
              </button>

              {/* Cards Container */}
              <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide -mx-5 px-5 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0 lg:overflow-visible lg:justify-center">
                {[
                  {
                    quote:
                      "NinthNode completely changed how I manage my Instagram. I went from spending 4 hours daily on DMs to just 30 minutes reviewing automation results.",
                    name: "Priya Sharma",
                    role: "Fashion Influencer",
                    company: "StyleVogue",
                    companyLogo: "SV",
                    bgColor: "bg-[#4ADE80]", // Bright green
                    image: "/testimonials/priya.jpg",
                  },
                  {
                    quote:
                      "The flow builder is incredibly intuitive. I created my first automation in under 10 minutes, and it's already generated 500+ leads for my business.",
                    name: "Rahul Mehta",
                    role: "CEO",
                    company: "TechVentures",
                    companyLogo: "TV",
                    bgColor:
                      "bg-gradient-to-b from-[#8B5CF6] via-[#EC4899] to-[#F97316]", // Purple to orange gradient
                    image: "/testimonials/rahul.jpg",
                  },
                  {
                    quote:
                      "Finally, a platform that understands creators! The Google Sheets integration is perfect for my team to track all our influencer campaigns.",
                    name: "Ananya Patel",
                    role: "Founder & CEO",
                    company: "CreatorHub",
                    companyLogo: "CH",
                  ...
                  <div
                    key={i}
                    className={`relative flex-shrink-0 w-[300px] sm:w-[350px] lg:w-[380px] h-[480px] sm:h-[520px] rounded-2xl overflow-hidden snap-center ${testimonial.bgColor}`}
                  >
                    {/* Glitch Effect Overlay - Horizontal stripes */}
                    <div className="absolute inset-0 pointer-events-none z-10">
                      {[...Array(20)].map((_, j) => (
                        <div
                          key={j}
                          className="absolute w-full h-[3px] bg-gradient-to-r from-transparent via-black/30 to-transparent"
                          style={{
                            top: `${40 + j * 3}%`,
                    ...
                    {/* Header - Company logo and person info */}
                    <div className="absolute top-0 left-0 right-0 z-20 p-5 sm:p-6 flex items-start justify-between">
                      {/* Company Logo */}
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center font-bold text-white text-sm">
                    ...
                    {/* Person Image Placeholder (silhouette area) */}
                    <div className="absolute inset-0 flex items-center justify-center pt-16">
                      <div className="w-40 h-48 sm:w-48 sm:h-56 rounded-full bg-black/10 flex items-center justify-center">
                        <span className="text-white/30 text-6xl sm:text-7xl font-bold">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 z-20 p-5 sm:p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-white/30 transition-colors">
        ...
        <section className="relative py-16 sm:py-24 px-5 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-neutral-800/50">
          <div className="relative max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              <p className="text-gray-500 dark:text-neutral-500 text-xs sm:text-sm uppercase tracking-wider mb-3 sm:mb-4">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-8 items-center">
              ...
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-pink-100 dark:bg-pink-950/30 border border-pink-200 dark:border-pink-900/30 hover:bg-pink-200 dark:hover:bg-pink-900/30 transition-colors">
                <span
                  className="text-pink-600 dark:text-pink-400 font-bold text-sm sm:text-xl tracking-tight"
              ...
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-orange-100 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900/30 hover:bg-orange-200 dark:hover:bg-orange-900/30 transition-colors">
                <span className="text-orange-600 dark:text-orange-400 font-black text-lg sm:text-2xl">
                  M
                </span>
                <span className="text-orange-600 dark:text-orange-400 font-medium text-xs sm:text-lg ml-0.5 hidden sm:inline">
                  yntra
                </span>
              </div>
              ...
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-red-100 dark:bg-red-950/30 border border-red-200 dark:border-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/30 transition-colors">
                <span className="text-red-600 dark:text-red-400 font-black text-sm sm:text-xl">
                  boAt
                </span>
              </div>
              ...
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-green-100 dark:bg-green-950/30 border border-green-200 dark:border-green-900/30 hover:bg-green-200 dark:hover:bg-green-900/30 transition-colors">
                <span className="text-green-600 dark:text-green-400 font-semibold text-xs sm:text-lg">
                  🌿<span className="hidden sm:inline"> Mamaearth</span>
                </span>
              </div>
              ...
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-purple-100 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-900/30 hover:bg-purple-200 dark:hover:bg-purple-900/30 transition-colors">
                <span className="text-purple-600 dark:text-purple-400 font-bold text-xs sm:text-xl tracking-widest">
                  SUGAR
                </span>
              </div>
              {/* Plum - Teal/Emerald */}
              <div className="h-12 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center bg-emerald-100 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/30 hover:bg-emerald-200 dark:hover:bg-emerald-900/30 transition-colors">
                <span className="text-emerald-600 dark:text-emerald-400 font-semibold text-sm sm:text-xl">
                  plum
                </span>
                <span className="text-emerald-500 dark:text-emerald-300 text-[8px] sm:text-xs ml-0.5 sm:ml-1">
                  ●
                </span>
              </div>
            </div>
        ...
        <section className="relative min-h-[80vh] sm:min-h-screen flex flex-col justify-center py-16 sm:py-32 border-t border-gray-200 dark:border-neutral-800/50 overflow-hidden">
          <div className="relative max-w-4xl mx-auto w-full px-5 sm:px-6 lg:px-8">
            <div className="text-center mb-10 sm:mb-16 animate-on-scroll">
              ...
              <p className="text-gray-500 dark:text-neutral-500 text-base sm:text-lg max-w-2xl mx-auto px-2">
                The fastest-growing influencers and creators use our platform to
                scale their engagement
              </p>
            </div>
          </div>
                ...
                {[...Array(2)].map((_, setIndex) => (
                  ...
                  >
                    {[
                      ...
                      >
                        <div
                          className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br ${creator.color} flex items-center justify-center text-gray-900 dark:text-white font-semibold text-sm sm:text-base flex-shrink-0`}
                        >
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-gray-500 dark:text-neutral-500 text-[10px] sm:text-xs">
                            @{creator.handle}
                          </span>
                        </div>
                      </a>
        ...
        <section
          id="resources"
          className="py-32 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-neutral-800"
        >
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 dark:text-neutral-500 text-lg max-w-2xl mx-auto">
                Read how our users are growing their audience and generating
                leads
              </p>
            </div>
              ...
              {[
                {
                  ...
                  excerpt:
                    "Learn how she automated her comment replies and increased engagement by 300% in just 3 months.",
                  category: "Case Study",
                  readTime: "5 min read",
                ...
                },
                {
                  ...
                  excerpt:
                    "Rahul shares his automation workflow that generated 500+ qualified leads for his online store.",
                  category: "Tutorial",
                  readTime: "8 min read",
                  slug: "ecommerce-500-leads-instagram-dms",
                  gradient:
                    "conic-gradient(from 285deg, #dac5b3 0.000deg, #acb6a4 90.000deg, #799d8d 180.000deg, #567f70 270.000deg, #515f4f 360.000deg)",
                },
                {
                  title: "Agency secrets: Managing 50 creator accounts",
                  excerpt:
                    "How one marketing agency scaled their influencer management with our automation tools.",
                  category: "Agency",
                  readTime: "6 min read",
                  slug: "agency-secrets-managing-50-creator-accounts",
                  gradient:
                    "conic-gradient(from 45deg, #a5c8e4 0.000deg, #e4ad47 30.000deg, #e590dc 60.000deg, #a67451 90.000deg, #655cd0 120.000deg, #604b5e 150.000deg, #9c44c2 180.000deg, #df466d 210.000deg, #e852b2 240.000deg, #af667e 270.000deg, #6a80a1 300.000deg, #5d9d90 330.000deg, #93b98f 360.000deg)",
                },
              ].map((post, i) => (
                <Link key={i} href={`/blog/${post.slug}`}>
                  <article className="group h-full bg-gray-100 dark:bg-neutral-900/30 border border-gray-200 dark:border-neutral-800 rounded-2xl overflow-hidden hover:border-gray-300 dark:hover:border-neutral-700 transition-all">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-gray-500 dark:text-neutral-600 text-xs">
                          {post.readTime}
                        </span>

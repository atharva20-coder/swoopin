            ...
            <div className="relative -mx-5 sm:-mx-6 lg:-mx-8">
              ...
              >
                ...
                {[
                  {
                    quote:
                      "This tool completely changed how I manage my Instagram. I went from spending 4 hours daily on DMs to just 30 minutes reviewing automation results.",
                    name: "Priya Sharma",
                  ...
                  {
                    quote:
                      "Finally, a platform that understands Indian creators! The Google Sheets integration is perfect for my team to track all our influencer campaigns.",
                    name: "Ananya Patel",
                  ...
                  {
                    quote:
                      "Best investment I've made for my business. The automated responses feel so natural that my followers can't tell the difference.",
                    name: "Vikram Singh",
                    role: "Fitness Coach",
                  ...
                  {
                    quote:
                      "Scheduling content used to take me hours. Now I batch everything in one sitting and let the platform handle the rest.",
                    name: "Neha Kapoor",
                    role: "Travel Blogger",
                  ...
                  <div
                    key={`first-${i}`}
                    className="flex-shrink-0 w-[300px] sm:w-[350px] bg-gray-100 dark:bg-neutral-900/50 border border-gray-200 dark:border-neutral-800 rounded-xl sm:rounded-2xl p-5 sm:p-6 hover:border-neutral-700 transition-colors"
                  >
                    ...
                    <p className="text-gray-600 dark:text-neutral-300 text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
                      &quot;{testimonial.quote}&quot;
                    </p>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 dark:text-neutral-500 text-xs sm:text-sm">
                          {testimonial.role}
                        </p>

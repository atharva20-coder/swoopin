    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-[72px]">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Navigation */}
          <div className="w-full lg:w-[250px] lg:sticky lg:top-[92px] lg:h-[calc(100vh-92px)] bg-[#f9fafb] rounded-lg p-6">
            <nav className="space-y-2">
              <Link href="#terms" className="block text-sm text-gray-900 hover:text-[#4F46E5] transition-colors underline">
                Terms of Service
              </Link>
              <Link href="#data-processing" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Data Processing Addendum
              </Link>
              <Link href="#privacy" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Privacy Policy
              </Link>
              <Link href="#candidate" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Candidate Privacy Statement
              </Link>
              <Link href="#providers" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Service Providers
              </Link>
              <Link href="#cookies" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Cookies Statement
              </Link>
              <Link href="#service-level" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
                Service Level Agreement
              </Link>
              <Link href="#ai" className="block text-sm text-gray-600 hover:text-[#4F46E5] transition-colors">
            ...
            <div className="max-w-3xl">
              ...
              <div className="prose prose-lg">
                ...
                <p className="text-gray-900 font-medium mb-8">
                  ...
                  REGISTERED VIA THE SITE OR THE APP. IF YOU DO NOT AGREE TO THESE TERMS OF
                  SERVICE, THEN YOU HAVE NO RIGHT TO ACCESS OR USE THE SERVICES.
                </p>

                <h2 id="privacy" className="text-2xl font-bold mb-6 mt-12">Privacy Policy</h2>
                ...
                <h3 className="text-xl font-semibold mb-4">2. Data We Collect</h3>
                <p className="text-gray-600 mb-4">Auctorn collects minimal data, including:</p>
                ...
                <h3 className="text-xl font-semibold mb-4">3. How We Use Your Data</h3>
                ...
                <p className="text-gray-600 mb-4">Auctorn does not sell or trade your data, but we may share data with:</p>
                <ul className="list-disc pl-6 mb-6 text-gray-600">
                ...
                <p className="text-gray-600 mb-4">If you have questions or concerns about this Privacy Policy, contact us at:</p>
                <p className="text-gray-600 mb-2">Email: atharvajoshi2520@gmail.com</p>
                <p className="text-gray-600 mb-6">Developer Website: devatharvajoshi.vercel.app</p>
              </div>
            </div>
          </div>
        </div>

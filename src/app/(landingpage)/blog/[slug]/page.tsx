...
export default async function BlogPostPage({
  ...
  const heroGradient = blogGradients[slug] || defaultGradient;
    ...
    <main className="min-h-screen bg-white dark:bg-black">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        <div className="text-center mb-4">
          <span
            className={`inline-block px-4 py-1.5 rounded-full text-sm font-medium ${getCategoryColor(post.category)}`}
          >
            {post.category}
          </span>
        </div>

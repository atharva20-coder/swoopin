  ...
  return (
    <div className="flex flex-col items-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16 max-w-3xl">
        <h1 className={`${sigmar.className} text-4xl md:text-5xl font-bold text-gray-900 mb-6`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            className="bg-[#2E329F] text-white px-8 py-2 rounded-full hover:bg-[#2E329F]/90 transition-all"
            size="lg"
          >
            Contact Sales
          </Button>
        ...
        <p className="text-sm text-gray-600 mt-4">
          Talk to an account specialist to get started, <a href="tel:+91-7000523270" className="text-[#2E329F] hover:underline">91-7000-523-270</a>.
        </p>
      ...
      <div className="text-center mb-16 max-w-3xl">
        <h2 className={`${sigmar.className} text-3xl font-bold text-gray-900 mb-4`}>
        ...
        <div className="text-center">
          <button
            ...
            className="bg-white hover:bg-[#2E329F]/10 font-semibold py-3 px-6 rounded-full border border-[#2E329F] text-[#2E329F]  shadow-sm transition-all duration-300 flex items-center gap-2 mx-auto"
          >
            <Instagram />
            DM us on instagram
          </button>
      ...
      {/* Plans Section */}
      <div className="w-full rounded-lg bg-gradient-to-r from-[#020024] via-[#090979] to-[#0061ff] p-8 -mx-4 sm:-mx-6 lg:-mx-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* FREE Plan */}
          <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
            <div className="text-[#2E329F] font-bold text-2xl mb-4">
              FREE
              <div className="text-xs text-gray-400 font-normal mt-1">Your current plan</div>
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-4">Standard</h3>
            <p className="text-gray-600 mb-6">Perfect for getting started with automation</p>
            <div className="mb-6">
            ...
            <div className="space-y-3">
              <p className="flex items-center gap-2 text-gray-600">
                <span className="text-[#2E329F]">✓</span> 200 DMs and Comments
              </p>
              <p className="flex items-center gap-2 text-gray-600">
          ...
          {/* PRO Plan */}
          <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
            <div className="text-[#2E329F] font-bold text-2xl mb-4">PRO</div>
            <h3 className="text-xl font-bold text-gray-900 mb-4">Smart AI</h3>
      ...
      <div className="text-center mt-16 max-w-3xl">
        <h2 className={`${sigmar.className} text-3xl font-bold text-gray-900 mb-6`}>
        ...
        <div className="mt-12 mb-8">
          <p className="text-lg text-gray-700 mb-4">We value your feedback! Help us improve our service.</p>
          <Button

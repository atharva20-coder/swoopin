    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <span
            className={cn(
              "px-1.5 py-0.5 rounded text-[10px] font-medium text-white flex items-center gap-1",
              typeLabels[type].bg,
            )}
          >
  ...
  const handleDrop = (e: React.DragEvent, targetDate: Date, hour?: number) => {
    ...
    if (automationData) {
      try {
        ...
        const dropDate =
          hour !== undefined
            ? new Date(targetDate.setHours(hour, 0, 0, 0))
            : targetDate;
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isDragOver &&
                      "bg-green-100 dark:bg-green-900/30 ring-2 ring-green-400 ring-inset",
                  )}
                >
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="overflow-x-auto h-full">
        <div className="min-w-[800px] h-full flex flex-col">
          <div className="grid grid-cols-8 border-b border-gray-200 dark:border-neutral-800 shrink-0">
          ...
          <div className="flex-1 overflow-y-auto">
            {HOURS.map((hour) => (
              <div
                key={hour}
                className="grid grid-cols-8 border-b border-gray-100 dark:border-neutral-800 min-h-[60px]"
              >
      ...
      <div className="flex-1 overflow-y-auto">
        {HOURS.map((hour) => {
          ...
          return (
            <div
              key={hour}
              className="flex border-b border-gray-100 dark:border-neutral-800 min-h-[80px]"
            >

    ...
    <div className="flex flex-col h-full p-6 animate-pulse">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <div className="h-10 w-24 bg-gray-200 dark:bg-neutral-800 rounded-lg" />
          <div className="h-10 w-36 bg-gray-200 dark:bg-neutral-800 rounded-lg" />
        </div>
      </div>
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex items-center gap-4 p-4 border-b border-gray-100 dark:border-neutral-800 last:border-0">
              ...
              <div className="flex gap-2">
                ...
                <div className="h-8 w-8 bg-gray-200 dark:bg-neutral-800 rounded" />
              </div>
            </div>
          ))}
        </div>

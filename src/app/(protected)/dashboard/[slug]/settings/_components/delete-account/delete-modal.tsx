  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button 
          variant="outline" 
          className="border border-red-600 bg-transparent hover:bg-red-50 dark:hover:bg-red-950 text-red-600 px-6 py-2 rounded-md font-medium transition-colors duration-200"
          disabled={isDeleting}
        >
          {isDeleting ? (
            <>
      ...
      <AlertDialogContent className="bg-white dark:bg-neutral-900 p-4 sm:p-6 rounded-md max-w-md w-[95%] sm:w-full mx-auto">
        ...
        <AlertDialogFooter className="mt-4 sm:mt-6 flex flex-col sm:flex-row gap-2 sm:gap-3">
          ...
          <AlertDialogAction 
            ...
            className="w-full sm:flex-1 bg-transparent border border-red-600 text-red-600 hover:bg-red-50 dark:hover:bg-red-950 px-3 sm:px-4 py-2 rounded-md font-medium transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent text-sm sm:text-base"
          >
            {isDeleting ? (
              <>

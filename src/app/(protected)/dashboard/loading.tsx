    ...
    <div className='min-h-screen bg-background p-3'>
          ...
          <div className='space-y-2'>
            {[...Array(6)].map((_, i) => (
              <div key={i} className='flex items-center gap-x-6 p-2'>
                <div className='h-8 w-8 rounded bg-gray-200 dark:bg-gray-900 animate-pulse' />
                <div className='h-4 w-24 bg-gray-200 dark:bg-gray-900 rounded animate-pulse' />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className='lg:ml-[var(--sidebar-width,250px)] lg:pl-10 lg:py-5 flex flex-col overflow-auto pb-24 transition-all duration-300'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {/* Analytics Cards */}
          {[...Array(3)].map((_, i) => (
            <div key={i} className='p-6 rounded-xl bg-white dark:bg-gray-900 shadow-sm'>
        ...
        <div className='mt-8 p-6 rounded-xl bg-white dark:bg-gray-900 shadow-sm'>
          <div className='flex justify-between items-center mb-6'>
